...
//	}
	...
	public ConsumerFactory<String, ProductRequest> consumerFactory() {
		...
		config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapString);
//		config.put(ConsumerConfig.GROUP_ID_CONFIG, "group_id");
	...
	// Creating a Listener
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, ProductRequest> ProductRequestListener() {
